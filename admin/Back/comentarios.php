            ...
            <div class="card-body">
              ...
              <form method="POST"  enctype="multipart/form-data">
                ...
                <table class="table table-xl-responsive-borderless"  id="tablajson" width="100%" cellspacing="0">
                  ...
                  <tbody>
                  <?php
                  foreach($consultaComentario as $peli){ ?>
                    <tr align="center">
                    <td><?php echo $peli['id_comentario']; ?></td>
                      <td><?php
                      $sql1 = "SELECT nombre, apellido FROM usuario 
                      WHERE id_usuario=".$peli['id_usuario'];
                    ...
                    foreach($consultaUsuario as $consul) {   
                      ...
                      WHERE id_pelicula=".$peli['id_pelicula'];
                      ...
                      <td><center>
                      <a href="edit-comentario.php?edit=<?php echo $peli['id_comentario'];?>"><i class="fas fa-edit"></a></i>&nbsp;&nbsp;
                      <a href="comentarios.php?del=<?php echo $peli['id_comentario'];?>"><i class="fas fa-trash-alt"></i></a></i></center>
                      </td>
                    </tr>
                  <?php } ?>
                  </tbody>
