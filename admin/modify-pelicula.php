...
include_once('../Helpers/funcs.php');
              ...
              <div class="table-responsive">
                    <form method="POST" action="" name="prod" enctype="multipart/form-data">
                      <table class="table bg-gradient-dark text-white" id="dataTable" width="100%" cellspacing="0">
                        ...
                        <tr>
                          <td align="right"><input type="submit"  name="add" value="Guardar" id="btnSavePeli" class="btn btn-success"></td>
                          <td align="left"><input type="reset" value="Reset" class="btn btn-danger"> <input type="button" value="Agregar mas detalles" class=" ml-3 btn btn-info" onclick="agregarFila()"></td>
  ...
  <script>
        ...
        console.log("la cantidad de filas son: " + rowCount);
        // Lo de arriba nos devuelve la cantidad de filas (tr) que tenemos en el table.
        ...
        function agregarFila() {
          ...
          cellNombre.innerHTML = "<input type='text' name='campo1' size='7' >";
          cellDetalle.innerHTML = "<input class='bg-danger' type='text'name='campo2' size='70' > <input type='button' value='Borrar' onclick='deleteRow(this)' name='campo3'>";
