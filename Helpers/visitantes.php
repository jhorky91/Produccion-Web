...
/* 
    ...
    function write_visita (){
        ...
        $archivo="../DataAccess/ip.txt";

        //Si es que quieres ignorar la propia IP escribirla aquí, esto se podría automatizar
        $ip="mi.ip.";
       ...
       // tiene importancia en mi contexto pero no es obligatorio
        ...
        else
        {
            ...
            $url = "http://localhost/Produccion-Web/Front/";
            $peticion = explode($url, $_GET['PATH_INFO']);
        ...
        $txt =  str_pad($new_ip,25). " ".
                ...
                str_pad($_SESSION['user'],25)." ";
                str_pad($_SESSION['id'],25)." ";
                        
        /* 
        $datosString = json_encode($txt);
